  ...
  return (<>
    ...
    {weatherDetails !== null && (<div className='card-wrapper border-radius-4' style={{ backgroundColor: "rgba(48, 198, 225, 0.23)", contain: "content" }}>
      <div className="card flex justify-between flex-col border-radius-4">
        <div className="card-top flex flex-col align-center justify-between ml-10 mr-10" onClick={() => dispatch(Open(details))}>
        ...
        <div className="card-footer flex" style={{ backgroundColor: "#f0f0f0", cursor: "pointer", borderRadius: "0 0 10px 10px" }}>
